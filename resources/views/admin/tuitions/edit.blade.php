            ...
            <div class="col">
                <nav aria-label="breadcrumb" class=" rounded-3 p-3 mb-4">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route("admin.jobs") }}">Tuitions</a></li>
                ...
                <form action="" method="post" id="editJobForm" name="editJobForm">
                    <div class="card border-0 shadow mb-4 ">
                        <div class="card-body card-form p-4">
                            <h3 class="fs-4 mb-1">Edit Tuition Details</h3>
                            <div class="row">
                                ...
                                <div class="col-md-6  mb-4">
                                    <label for="" class="mb-2">Class<span class="req">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <label for="" class="mb-2">Subject<span class="req">*</span></label>
                                ...
                                <div class="col-md-6  mb-4">
                                    <label for="" class="mb-2">No. of student<span class="req">*</span></label>
                                    <input value="{{ $job->vacancy }}" type="number" min="1" placeholder="student number" id="vacancy" name="vacancy" class="form-control">
                                    <p></p>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                <label for="" class="mb-2">Tution Code</label>
                                <input value="{{ $job->keywords }}" type="text" placeholder="code" id="keywords" name="keywords" class="form-control">
                            </div>

                            {{-- @if(empty($job->company_name)) --}}

                            <h3 class="fs-4 mb-1 mt-5 border-top pt-5"> Batch info</h3>

                            <div class="row">
                                <div class="mb-4 ">
                                    <label for="" class="mb-2">Name</label>
                                    <input value="{{ $job->company_name }}" type="text" placeholder="Batch Name" id="company_name" name="company_name" class="form-control">
                                    <p></p>
                                </div>
