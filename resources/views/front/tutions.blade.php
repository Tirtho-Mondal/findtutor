            ...
            <div class="col-md-4 col-lg-3 sidebar mb-4">
                <form action="" name="searchForm" id="searchForm">
                    <div class="card border-0 shadow p-4">
                        <div class="mb-4">
                            <h2>Tuition Code</h2>
                            <input value="{{ Request::get('keyword') }}" type="text" name="keyword" id="keyword" placeholder="code" class="form-control">
                        </div>
                        ...
                        <table>
                            <th>
                                <p><span class="border border-primary"> <button type="submit" class="btn btn-success">Search</button></span></p>
                        

                            </th>
                            <th>
                                <p><span class="border border-primary"> <a href="{{ route("jobs") }}" class="btn btn-warning">Reset</a></button></span></p>
                ...
                <div class="job_listing_area">                    
                    <div class="job_lists">
                        <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="card border-0 p-3 shadow mb-4">
                                        <div class="card-body">
                                            ...
                                            <p class="fst-italic">{{ Str::words(strip_tags($job->description), $words=10, '...') }}</p>
                                            ...
                                            <div class="bg-light p-3 border">
                                                ...
                                                <p class="mb-0">
                                                    ...
                                                    <span class="ps-1">TK {{ $job->salary }} </span>
                                                </p> 
                                                @endif                                                
                                            </div>
    
                                            <div class="d-grid mt-3">
                                                <a href="{{ route('jobDetail',$job->id) }}" class="btn btn-info">Details</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            @else
                            <div class="col-md-12">Tuition not found</div>                                
                            @endif                           
                        </div>
                    </div>
                </div>
